...
def export_csv():
    ...
    # Pre-parse violation types for unique reasons to optimize row iteration
    parsed_reasons = {}
    violation_types = set()
    ...
    for reason in unique_reasons:
        ...
        for r in reason.split(","):
            ...
            if r_lower.startswith("length"):
                ...
                types.add(r)  # fallback for fully dynamic
    ...
    # Base columns
    headers = ["Domain", "Account Name", "Password Not Required", "Password Never Expires", "Kerberoastable", "ASREPRoastable"]
...
def high_value():
    ...
    return render_template(
        "high_value.html", users=hv_data, page=page, per_page=per_page, groups=high_value_groups, selected_group=group_filter
    )
